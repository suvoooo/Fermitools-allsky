...
# 
        ...
        # 
            ...
            if result_fsrq>=10**(E100bins_fsrq_list[0]) and result_fsrq <= 10**(E100bins_fsrq_list[-1]): # 10**(lbin), 10**(hbin)
...
#                   result_list.pop()
    ...
    if (len(c_lp_a_fsrq_comb_bcu) <= 1370) and (len(c_lp_a_fsrq_comb_bcu) >= 980):
        ...
        mock_xmlfile_fsrq_bcu_comb = open('./gen_fsrq_corrected/mock_4FGL_V22_fsrqvar_comb_bcu_file%dS%d.xml' %(start_source_num, source_numbers_check), 'w')
